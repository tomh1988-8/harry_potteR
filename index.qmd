---
title: "Coffee and Code R Workshop <img src='materials/images/cng.png' style='float: right; height: 75px;'>"
...
-   Session 2 is called "`Spells`" and equips the reader with a spell book full of tidyverse staple functions.
...
[📂 View the Repo](https://github.com/tomh1988-8/harry_potteR){target="_blank"}

or get in touch at tom.hunter\@cityandguilds.com for a zip folder containing the materials needed to run the code.
