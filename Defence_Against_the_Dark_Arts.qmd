...
Note that our first function just returns some print outs. More than not, they will return data, e.g., in a dataframe. This means our template wrapper will look like this:
